...
# Nowe Nowe Nowe Nowe Nowe Nowe Nowe Nowe Nowe Nowe Nowe Nowe Nowe Nowe
"""Pliki Gra_bazowa_03-04 ilustrują, jak zrobić w Pythonie prostą grę,
...
def game_loop():
    ...
    while play_game:
        ...
        """Skoro narysowaliśmy już ,,thing'', gdzie chcieliśmy, to teraz
...
pygame.quit()
"""PyGame tak jak został włączony (zainicjalizowany),
